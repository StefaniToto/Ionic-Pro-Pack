...
export class DataService {
  ...
  details = [
    {
      userDetails: 'A BITS and IIT Delhi alumni established web and mobile development product and service providing company located at NY and bangalore.',
  ...
  tinderPlus = [
    {
      ...
      subHead1: 'Give me the ability  my last swipe',
      toggle: true
    }, {
